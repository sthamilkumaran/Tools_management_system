<div>
    ...
    <div class="drop-shadow-md px-6 py-6 lg:px-8">
        <form class="" wire:submite.prevent=''>
            <h1
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="User_location" id="User_location" wire:model='User_location'
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder="" required />
            ...
            <div class="relative z-0 w-full mb-6 group">
                <label class="block mb-2 text-sm font-medium text-gray-500 dark:text-white"
                    for="User_selfie">Selfie</label>
                <input
                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                    aria-describedby="user_avatar_help" name="User_selfie" id="User_selfie" type="file" wire:model='User_selfie' required>
            </div>
            <div class="relative z-0 w-full mb-6 group">
                <label class="block mb-2 text-sm font-medium text-gray-500 dark:text-white"
                    for="User_layout">Layout</label>
                <input
                    ...
                    aria-describedby="user_avatar_help" name="User_layout" id="User_layout" wire:model='User_layout' name="" type="file" required>
            </div>
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                    <label for="User_task"
                        class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Est.Task</label>
                    <input type="text" name="User_task1" id="User_task1" wire:model='User_task1'
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder="Task_01" required />
                    <input type="text" name="User_task2" id="User_task2" wire:model='User_task2'
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder="Task_02" required />
                    <input type="text" name="User_task3" id="User_task3" wire:model='User_task3'
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder="Task_03"  />
                    <input type="text" name="User_task4" id="User_task4" wire:model='User_task4'
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder="Task_04"  />
                    <input type="text" name="User_task5" id="User_task5" wire:model='User_task5'
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder="Task_05"  />

                </div>
                <div class="relative z-0 w-full mb-6 group">
                    <label for="User_T_time"
                        class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Est.Time</label>
                    <input type="time" name="User_T_time1" id="User_T_time1" wire:model='User_T_time1'
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder="Time_01" required />
                    <input type="time" name="User_T_time2" id="User_T_time2" wire:model='User_T_time2'
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder="Time_02" required />
                    <input type="time" name="User_T_time3" id="User_T_time3" wire:model='User_T_time3'
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder="Time_03"  />
                    <input type="time" name="User_T_time4" id="User_T_time4" wire:model='User_T_time4'
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder="Time_04"  />
                    <input type="time" name="User_T_time5" id="User_T_time5" wire:model='User_T_time5'
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder="Time_05" />
                </div>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" name="User_status" id="User_status" wire:model='User_status'
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
            ...
            <div class="relative z-0 w-full mb-6 group">
                <label for="Special_note" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Special
                    Note</label>
                <textarea id="Special_note" rows="4" wire:model='Special_note' name="Special_note"
