<div class="">
    <br>
    <button data-modal-target="out-modal" data-modal-toggle="out-modal"
    ...
    {{-- in model --}}
    <button data-modal-target="in-model" data-modal-toggle="in-modal"
        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 "
        type="button">
        in
    </button>
    ...
    <!-- in Modal -->
    <div id="in-modal" tabindex="-1" wire:ignore self
        class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
        <div class="relative w-full h-full max-w-md md:h-auto">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form>
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="text" name="inuserName" id="inuserName" wire:model='inuserName'
                                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder="" required />
                        ...
                        <br>
                        <div class="relative max-w-sm">
                            <input type="text" wire:model='inoutDate'
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-2 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="{{$today1}}" disabled>
                        </div>
                        <br>
                                ...
                                <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        ...
                                        <input type="number" id="visitors"
                                            class=" bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-2/6 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            style="margin-right: 10%;" placeholder="" required>
                                        <textarea id="chat" rows="1"
                                            class="block mx-4 p-2 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <button type="button" wire:click='instore'
                            class="text-blue-900 bg-gradient-to-r from-blue-500 to-blue-100 hover:bg-gradient-to-l focus:ring-1 focus:outline-none focus:ring-purple-200 dark:focus:ring-blue-700 font-medium rounded-lg  mt-10 text-sm  text-center px-5 py-2.5 hover:shadow-xl hover:shadow-blue-500/50">I
                            accept</button>
                        <button data-modal-hide="in-modal" type="button"
                            class="text-blue-900 bg-gradient-to-r from-red-500 to-red-100 hover:bg-gradient-to-l focus:ring-1 focus:outline-none focus:ring-red-200 dark:focus:ring-red-700 font-medium rounded-lg  mt-10 text-sm  text-center px-5 py-2.5 hover:shadow-xl hover:shadow-red-500/50 border-red-600">Decline</button>
                        {{-- <button type="submit"
